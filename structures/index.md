...
| [**`funding-taxonomy-and-capital-selection.md`**](./funding-taxonomy-and-capital-selection.md) | **Capital Taxonomy & Selection** | Comprehensive 5-archetype funding framework: benefits, risks, cost of dilution, governance control loss, risk tolerance, and suitability logic. |
...
```mermaid
flowchart TD
    C1["1. P-H Search Space Canvas"] --> C2["2. Universal Functional Analysis (S-A-O)"]
    C2 --> C3["3. Customer Activity Chain & Linkages"]
    C3 --> C4["4. Business Architecture Alignment Canvas"]
    C4 --> C5["5. Cloverleaf Due Diligence Scorecard"]
    C5 --> C6["6. Deep-Tech MVP & Killer Experiment Canvas"]
    C6 --> C7["7. Cash Engine & Working Capital Calculator"]
```
