...
```mermaid
flowchart TD
    subgraph Supply["Supply Side (Technology Push)"]
        Seed["<b>Raw Technology Seed</b><br/>TRL 1–3 laboratory proof-of-concept"] --> Rep["<b>Problem Representation</b><br/>Perspective-Heuristic (P-H) coordinates"]
        Rep --> Func["<b>Universal Functional Deconstruction</b><br/>Subject-Action-Object (S-A-O) triads"]
    end

    subgraph Demand["Demand Side (Market Pull)"]
        Pain["<b>Customer Friction Points</b><br/>Functional, economic, informational & emotional"] --> JTBD["<b>Jobs-to-Be-Done & Workflows</b><br/>Customer Activity Chain mapping"]
    end

    Func <===>|"<b>CLOSED-LOOP TECHNOLOGY-MARKET FIT</b><br/>Decisive Main Parameters of Value (10x MPV)"| JTBD
    JTBD --> Fit["<b>Validated Market Beachhead</b><br/>Ready for Business Architecture"]
```
