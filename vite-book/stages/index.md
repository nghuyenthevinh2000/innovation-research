...
```mermaid
flowchart TD
    S1["<b>Stage 1: Discovery & Seeds</b><br/>TRL 1–3: Fundamental discovery & laboratory proof-of-concept"]
    S2["<b>Stage 2: Technology-Market Fit</b><br/>P-H coordinate framing, functional deconstruction & customer workflows"]
    S3["<b>Stage 3: Business Architecture</b><br/>Synthesize Business Model & Operating Delivery Engine"]
    S4["<b>Stage 4: Market Assessment & MVPs</b><br/>Cloverleaf due diligence, 100-interview funnel & deep-tech MVP probing"]
    S5["<b>Stage 5: De-Risking & Capital</b><br/>Cash engine optimization, killer experiments & staged capital"]
    S6["<b>Stage 6: Spin-Offs & Scaling</b><br/>TTO clean IP, syndicate choreography & standards dominance"]
