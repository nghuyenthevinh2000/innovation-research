...
```mermaid
flowchart TD
    subgraph BM["PILLAR I: BUSINESS MODEL"]
        VC["<b>Value Creation</b><br/>Why customers buy"]
        VP["<b>Value Capture</b><br/>How you get paid"]
    end

    subgraph OM["PILLAR II: OPERATING MODEL"]
        S["<b>Structure</b><br/>Product / Service / Platform"]
        C["<b>Capabilities</b><br/>Core proficiencies"]
        A["<b>Assets</b><br/>IP & Proprietary data"]
    end

    BM <-->|"<b>ALIGNMENT MATRIX</b>"| OM
```
