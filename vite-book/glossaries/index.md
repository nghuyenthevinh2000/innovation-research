...
- [**Stage 2: Technology-Market Fit & Needs-Seeds Synchronization**](./master-glossary.md#stage-2-technology-market-fit--needs-seeds-synchronization): Perspective, Heuristic, Perspective-Heuristic Pairs, Magic Square, Cognitive Diversity, Cross-Domain Transfer, Crowdsourcing, Crowdsourced Search, Open Innovation, Solver Profile, Technology Seed, Customer Need, Seeds-Driven Innovation, Needs-Driven Innovation, Accelerated Innovation, Functional Analysis, Function, MPV, S-A-O Triad, Jobs-to-Be-Done (JTBD), Outcomes-Driven Innovation (ODI), Customer Activity Chain, Needs Statement (MRD).
...
- [**Stage 4: Market Assessment, Due Diligence & MVPs**](./master-glossary.md#stage-4-market-assessment-due-diligence--deep-tech-mvps): TRL (1–9), Cloverleaf Model (Framework), Freedom to Operate (FTO), Blocking Patents, Market Antibodies, 10x Imperative, 100-Interview Funnel, Customer Validation, Mom Test, Disconfirming Evidence, Conceptual MVP, Simulated MVP (Wizard of Oz), Prototypical MVP, Think-Aloud Protocol.
...
| [**`Crowdsourcing`**](./master-glossary.md#crowdsourcing) | A method of finding information or solutions to a problem by inviting ideas and solutions from a large set of experts or laypeople outside organizational boundaries (e.g., open challenges, competitions). |
...
| [**`Seeds-Driven Innovation`**](./master-glossary.md#seeds-driven-innovation) | A process for innovation where the starting point is the capability that a technology can offer. |
| [**`Needs-Driven Innovation`**](./master-glossary.md#needs-driven-innovation) | A process for innovation where the starting point is a deep understanding of a customer's needs and wants. |
...
| [**`Function`**](./master-glossary.md#function) | The main reason that we buy a certain product or technology, defined as the interaction between different components of the system (expressed in universal terms within functional analysis). |
...
| [**`Needs Statement (MRD)`**](./master-glossary.md#needs-statement) | A statement that expresses who the customer is, including information regarding: activities, behaviors, motivations, and specific problems experienced when trying to derive a benefit or utility (also called a Market Requirements Document or MRD). |
...
| [**`The Cloverleaf Model (Framework)`**](./master-glossary.md#the-cloverleaf-model-the-cloverleaf-framework) | A framework for determining whether a technology venture is ready to be taken to market across four dimensions: **technology readiness**, **market readiness**, **commercial readiness**, and **team readiness**. |
...
| [**`Technology Transfer`**](./master-glossary.md#technology-transfer) | The process of moving a technology or capability developed in a laboratory or other research setting to a commercial use form through a startup, large established business, or other organization (also called technology commercialization). |
...
| [**`Network Effect`**](./master-glossary.md#network-effect) | An effect observed in certain products and services where value increases as more users use it (e.g., Facebook, Uber). |
| [**`Licensing Arrangement`**](./master-glossary.md#licensing-arrangement) | A contract where a licensee pays a fee to use intellectual property or assets owned by the licensor, enabling R&D-heavy startups to monetize without direct mass manufacturing. |
| [**`Joint-Development Partnership`**](./master-glossary.md#joint-development-partnership) | An agreement between two organizations to develop a new product, service, solution, or business line. |
| [**`Market Access`**](./master-glossary.md#market-access) | The ability of a company to access a targeted set of customers. |
